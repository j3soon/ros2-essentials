...
class Real2SimBridge(Node):
    def __init__(self):
        ...
        self.publisher_robot_right = self.create_publisher(JointState, "dg5f_right_joint_command", 10)
    ...
    def receive_robot_state(self):
        while not self.stop_thread:
            try:
                ...
                right_gripper_joints = [math.radians(val / 10.0) for val in unpacked_data[1:21]]
                self.joint_state_right.position = right_gripper_joints
