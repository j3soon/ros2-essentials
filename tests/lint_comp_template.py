...
compare_file_with_template("docker/Dockerfile", ignored_workspaces=["ros1_bridge_ws", "rtabmap_ws"])
compare_file_with_template("docker/cyclonedds.xml", ignored_workspaces=["ros1_bridge_ws"])
